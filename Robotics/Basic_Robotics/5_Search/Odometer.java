...
//		this.width = 8.3;//8.3
	...
	private void getDisplacementAndHeading(double[] data) {
		...
		data[0] = (leftTacho * Lab5.WHEEL_RADIUS + rightTacho *  Lab5.WHEEL_RADIUS) * Math.PI / 360.0;
		data[1] = (rightTacho *  Lab5.WHEEL_RADIUS - leftTacho *  Lab5.WHEEL_RADIUS) / Lab5.TRACK;
	}
